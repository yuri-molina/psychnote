...
export const streamRoute = async (fastify) => {
    ...
    app.options('/triage/stream/:jobId', optionsHandler);
    app.options('/api/triage/stream/:jobId', optionsHandler);
    // Expose both /triage/stream/:jobId and /api/triage/stream/:jobId for compatibility
    app.get('/triage/stream/:jobId', { schema: routeSchema }, streamHandler);
    app.get('/api/triage/stream/:jobId', { schema: routeSchema }, streamHandler);
};
