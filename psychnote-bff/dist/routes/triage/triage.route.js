...
import { TriageAsyncRequestSchema, TriageAsyncResponseSchema, ErrorResponseSchema, } from '../../schemas/index.js';
export const triageRoute = async (fastify) => {
    const app = fastify.withTypeProvider();
    const bffCallbackUrl = process.env.BFF_CALLBACK_URL ?? 'http://localhost:4000/api/webhooks/triage-result';
    app.post('/triage', {
        schema: {
...
//# sourceMappingURL=triage.route.js.map