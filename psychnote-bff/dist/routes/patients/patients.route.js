import { PatientsResponseSchema, PatientRecordSchema, ErrorResponseSchema, } from '../../schemas/index.js';
import { z } from 'zod';
        ...
        history: [
            {
                ...
                current_note: 'HMA: Paciente trazido por vizinho devido a isolamento social e choro copioso há 3 dias. Refere luto recente (morte inesperada da irmã há duas semanas) associado a demissão sumária do emprego.',
                red_flags: [
                ...
                clinical_justification: 'Paciente com ideação suicida ativa estruturada, meio letal disponível e plano imediato após estressores agudos graves.',
                audit_alerts: [
        ...
        history: [
            {
                ...
                risk_level: 'Alto/Iminente',
                current_note: 'HMA: Apresenta-se à consulta em sofrimento psíquico agudo e intolerável após término abrupto de relacionamento conjugal. Apresenta desesperança grave, anedonia global, apatia e insônia terminal.',
                red_flags: [
                ...
                clinical_justification: 'Quadro de sofrimento agudo com acúmulo clandestino de fármacos letais e planejamento explícito para o próximo fim de semana.',
                audit_alerts: [
        ...
        history: [
            {
                ...
                risk_level: 'Alto/Iminente',
                current_note: 'HMA: Paciente relata que as vozes imperativas retornaram com extrema intensidade há uma semana, ordenando que ele se jogue da ponte do metrô para purificar seus pecados.',
                red_flags: [
                ...
                clinical_justification: 'Esquizofrenia paranoide descompensada com alucinações imperativas e plano logístico mapeado.',
                audit_alerts: [
        ...
        history: [
            {
                ...
                risk_level: 'Moderado',
                current_note: 'HMA: Paciente comparece à consulta queixando-se de aumento da labilidade emocional após conflito interpessoal recente no ambiente de trabalho. Refere pensamentos recorrentes de que seria melhor desaparecer.',
                red_flags: [
                ...
                clinical_justification: 'Ideação passiva flutuante sem planejamento ativo, amparada por fortes fatores de proteção interpessoal.',
                audit_alerts: [
        ...
        history: [
            {
                ...
                risk_level: 'Moderado',
                current_note: 'HMA: Relata ressurgimento de pensamentos passivos de morte associados a insônia inicial de rebote e cansaço no último mês.',
                ...
                clinical_justification: 'Depressão recorrente com ideação passiva sem intenção ou plano ativo.',
                audit_alerts: [
        ...
        history: [
            {
                ...
                risk_level: 'Moderado',
                current_note: 'HMA: Relata piora dos sintomas álgicos na última quinzena, acompanhada de sentimentos de inutilidade e pensamentos de morte passivos.',
                ...
                clinical_justification: 'Ideação passiva associada a estresse álgico crônico, com forte preservação da aliança terapêutica.',
                audit_alerts: [],
            },
        ],
    },
        ...
        history: [
            {
                ...
                risk_level: 'Baixo',
                current_note: 'HMA: Comparece ao consultório referindo cansaço físico persistente, letargia e dificuldades de concentração nas últimas duas semanas.',
                ...
                clinical_justification: 'Sintomas depressivos leves situacionais, sem ideação ativa ou planejamento.',
                audit_alerts: [],
            },
        ],
    },
        ...
        history: [
            {
                ...
                risk_level: 'Baixo',
                current_note: 'HMA: Queixa-se de intensificação discreta da desmotivação e fadiga crônica, acompanhada de sintomas somáticos como dores musculares difusas.',
                ...
                clinical_justification: 'Quadro distímico crônico compensado, sem qualquer intenção ou plano suicida.',
                audit_alerts: [],
            },
        ],
    },
        ...
        history: [
            {
                ...
                risk_level: 'Baixo',
                current_note: 'HMA: Relata quadro de exaustão profunda, insônia de conciliação e dor física difusa após recente promoção e aumento da carga de trabalho corporativo.',
                red_flags: ['Sobrecarga ocupacional severa'],
                protection_factors: ['Crítica preservada', 'Ausência total de ideação autolesiva'],
                clinical_justification: 'Síndrome de esgotamento profissional (Burnout) sem risco suicida identificável.',
                audit_alerts: [],
            },
        ],
    },
};
export const patientsRoute = async (fastify) => {
    const app = fastify.withTypeProvider();
    // GET /patients and GET /api/patients
    const patientsHandler = async (_request, reply) => {
    ...
    const recordHandler = async (request, reply) => {
        ...
        const historicalItems = baseRecord?.history ?? [];
        // Prepend in-progress entry from active job (newest first)
        const historyWithJob = activeJob
            ? [
                {
                    id: activeJob.job_id,
        ...
        const response = {
            ...
            active_job_status: activeJobId ? 'processing' : null,
    ...
    const historyHandler = async (request, reply) => {
        const { patient_id } = request.params;
        try {
            ...
            return reply.code(200).send({
                ...
                history: fallbackRecord.history.map((h) => ({
                    timestamp: h.date,
...
//# sourceMappingURL=patients.route.js.map